...
import { phoneNumberValidator } from './ngx-intl-mobile-number-input.validator';

@Component({
  selector: 'ngx-intl-mobile-number-input',
  templateUrl: './ngx-intl-mobile-number-input.component.html',
  styleUrls: ['./ngx-intl-mobile-number-input.component.scss'],
  providers: [
    CountryCode,
    {
      provide: NG_VALUE_ACCESSOR,
      // tslint:disable-next-line:no-forward-ref
      useExisting: forwardRef(() => NgxIntlMobileNumberInputComponent),
      multi: true,
    },
    {
...
export class NgxIntlMobileNumberInputComponent implements OnInit, OnChanges {
